...
class SteamENV_no_same_item(object):
...
class Steam_Grounding_Model(object):
    ...
    def __init__(self, model_path, config, batch_size=16):
        ...
        if 'llama' in self.model_path.lower():
            ...
            self.steam_embedding = torch.load("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/zhangjizhi/jizhizhang_zhangjizhi/fairness/echo_chamber/agentamber/BiLLP-main/env/steam/steam_embedding_task.pt")['embeddings'].cuda()
            self.steam_index = torch.load("/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/zhangjizhi/jizhizhang_zhangjizhi/fairness/echo_chamber/agentamber/BiLLP-main/env/steam/steam_embedding_task.pt")['indexs'].cuda()
            
            with open('/mnt/dolphinfs/hdd_pool/docker/user/hadoop-aipnlp/zhangjizhi/jizhizhang_zhangjizhi/fairness/echo_chamber/agentamber/BiLLP-main/env/steam/datamaps.json') as f:
